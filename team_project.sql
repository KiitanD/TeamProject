...
--
-- Host: localhost
-- Generation Time: Nov 25, 2021 at 08:23 PM
...
INSERT INTO `customers` (`cust_id`, `fname`, `password`, `phone`, `email`, `address`) VALUES
(5, 'Akosua', 'c7bbf35cdb8c5af64411e26c1fa3787d', '024514542566', 'akosua@gmail.com', '1 University Avenue, Berekuso'),
(7, 'Hortance', '029317980e2a86e9c5b9ad87e6244398', '023514542565', 'hortance@gmail.com', '1 University Avenue, Berekuso'),
(8, 'Nana', 'bce1404eaad206b0a6856b179f40e990', '022514542564', 'nana@gmail.com', '1 University Avenue, Berekuso'),
(94, 'Kiitan', 'kiitan', '0215142563', 'kndside@gmail.com', '1 University Avenue, Berekuso');
...
--
ALTER TABLE `customers`
  MODIFY `cust_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `order_customer constraint` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`cust_id`),
